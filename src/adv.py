...
items = {
    'gun': Item('gun', 'shoots stuff'),
    'shield': Item('shield', 'a well worn shield'),
    'key': Item('key', 'opens a mysterious door'),
    'stick': Item('stick', 'stick from branch, can be used as a weapon')
}

room = {
    'outside':  Room("Outside Cave Entrance",
                     "North of you, the cave mount beckons", [items['stick']]),
